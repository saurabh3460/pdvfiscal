	...
	return func(c *macaron.Context) {
		defer func() {
			if err := recover(); err != nil {
				...
				//c.Data["AppSubUrl"] = settings.AppSubUrl
				//c.Data["Theme"] = settings.DefaultTheme
				...
				if ok && ctx.IsApiRequest() {
					...
					resp["message"] = "Internal Server Error - Check the Gerenciador server logs for the detailed error message."
					...
					//c.HTML(500, settings.ERR_TEMPLATE_NAME)
				}
			}
		}()
